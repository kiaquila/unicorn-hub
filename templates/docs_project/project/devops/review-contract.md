...
When Codex has no inline findings, a top-level `Codex Review:` summary comment from the trusted Codex bot also satisfies the active gate cycle if it appears after a fresh trusted `@codex review` trigger.
